...
export default function SidebarLayout() {
  ...
  const estatisticas = [
    { icone: User, nome: "Clientes", valor: "4793",cor:"blue" },
    { icone: Package, nome: "Produtos", valor: "820",cor:"yellow" },
    { icone: TimerReset, nome: "Serviços", valor: "4",cor:"green" },
    { icone: FileText, nome: "Ordens", valor: "475",cor:"pink" },
    { icone: ScrollText, nome: "Garantias", valor: "45",cor:"purple" },
    { icone: CircleArrowUp, nome: "Receita - Dia", valor: "R$ 451",cor:"green" },
    { icone: CircleArrowDown, nome: "Despesa - Dia", valor: "R$ 352",cor:"red" },
  ]
                ...
                return (
                  <div key={index} className="w-50 h-25 bg-black rounded-xl flex hover:cursor-pointer hover:bg-neutral-900">
                    <div className="flex flex-col flex-1 px-8">
                      <h2 className="text-white text-sm whitespace-nowrap pt-4">{data.nome}</h2>
              ...
              {estatisticas.map((data, index) => {
                ...
                return (
                  <div key={index} className="flex items-center pl-4 gap-4 mb-4 cursor-pointer rounded-md hover:bg-neutral-200">
                    <Icone className={`w-6 h-6 font-medium text-${data.cor}-600 font-bold`}/>
                    <div>
